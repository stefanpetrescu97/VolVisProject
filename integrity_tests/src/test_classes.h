...
public:
    ...
    provide_const_member_function_access(getVoxelLinearInterpolate)

    provide_static_member_function_access(weight)
    provide_static_member_function_access(cubicInterpolate)
    provide_const_member_function_access(bicubicInterpolateXY)
    provide_const_member_function_access(getVoxelTriCubicInterpolate)
};
...
public:
    ...
    provide_static_member_function_access(linearInterpolate)
    provide_const_member_function_access(getGradientVoxelLinearInterpolate)
};
